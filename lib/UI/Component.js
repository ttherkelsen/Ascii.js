...
class Component extends Core {
	...
	me._dirty = null;  // FIXME: Not used atm
	me._size = null;   // (w, h) size assigned by container
        me._bbox = null;   // bounding box (relative to container) 
    }
	...
	if (!me._dirty) {
	    me._dirty = Array(me._size.h * me._size.w); // Use sparse Array
	}
